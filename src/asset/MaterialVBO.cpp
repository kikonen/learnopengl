...
{
    KI_GL_CALL(glVertexArrayVertexBuffer(vao, VBO_MATERIAL_BINDING, m_vbo, 0, sizeof(MaterialEntry)));
    {
        ...
        KI_GL_CALL(glVertexArrayBindingDivisor(vao, VBO_MATERIAL_BINDING, 0));
    }
}

...
namespace
{
    ...
    {
        auto typeId = SID_REGISTER(baseId).asSid();
        ...
        const std::string& baseId)
    {
        ...
        if (baseId == ROOT_ID) {
            ...
            auto nodeId = SID_REGISTER(baseId).asSid();
...
namespace model
{
        ...
        const glm::vec3& tilePositionOffset)
    {
        ...
        ki::socket_id socketId = SID_REGISTER(cloneData.m_socketId).asSid();
        ...
        const glm::vec3& positionOffset)
    {
        ...
        const ki::socket_id socketId = SID_REGISTER(nodeData.m_socketId).asSid();
        ...
        state.m_tagId = SID_REGISTER(nodeData.m_tagId).asSid();

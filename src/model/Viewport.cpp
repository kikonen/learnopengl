...
namespace model
{
        ...
        m_program{ Program::get(programId) }
    {
        ...
        setViewUpdate([this, origPosition, origDegrees](Viewport& vp, const UpdateViewContext& ctx) {
    ...
    {
        m_viewUpdate(*this, ctx);
        updateTransform(ctx);
    }

    void Viewport::bind(const render::RenderContext& ctx)
    {
        invokeBindBefore();

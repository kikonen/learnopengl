...
void TextureCube::prepare()
{
    ...
    constexpr size_t VERTEX_ENTRY_SIZE = 8;
    ...
    glVertexArrayAttribFormat(m_vao, ATTR_NORMAL, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float));
    glVertexArrayAttribFormat(m_vao, ATTR_TEX, 2, GL_FLOAT, GL_FALSE, 6 * sizeof(float));

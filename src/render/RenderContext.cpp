    ...
    m_aspectRatio((float)width / (float)height)
{
    ...
    m_data = {
        ...
        0,
        m_parent ? m_parent->m_camera->getWorldPosition() : glm::vec3{},
        0,
        m_parent ? m_parent->m_camera->getViewFront() : glm::vec3{},
        0,
        m_parent ? m_parent->m_camera->getViewUp() : glm::vec3{},
        0,
        m_parent ? m_parent->m_camera->getViewRight() : glm::vec3{},
        0,
        assets.fogColor,
        m_resolution,

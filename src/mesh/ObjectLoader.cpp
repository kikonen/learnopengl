...
namespace mesh {
    ...
    void ObjectLoader::splitFragmentValue(const std::string& v, std::vector<std::string>& vv) {
        util::splitString(v, vv, '/');
    }

    unsigned int ObjectLoader::resolveVertexIndex(
        std::unordered_map<glm::vec3, std::vector<int>, Vec3MapCompare>& vertexMapping,
    ...
    glm::vec3 ObjectLoader::createNormal(
        std::vector<glm::vec3>& positions,
        std::vector<glm::vec3>& normals,
        glm::uvec3 pi)
    {
    ...
    void ObjectLoader::createTangents(
        std::vector<glm::vec3>& positions,
        std::vector<glm::vec2>& textures,
        std::vector<glm::vec3>& normals,
        std::vector<glm::vec3>& tangents,
    ...
    void ObjectLoader::loadMaterials(
    ...
    std::string ObjectLoader::resolveTexturePath(

...
(function()
  ...
  local ANIM_IDLE_2 = util.sid("idle_break")
  local ANIM_HIT = util.sid("hit")

  local ANIM_SWING_HEAVY = util.sid("attack_1")
  local ANIM_SWING_NORMAL = util.sid("attack_2")
  local ANIM_SWING_QUICK = util.sid("attack_3")
